...
\bibitem[{Abdulaziz and Koller(2022)}]{abdulaziz22}
Abdulaziz, M.; and Koller, L. 2022.
\newblock Formal Semantics and Formally Verified Validation for Temporal
  Planning.
\newblock In \emph{{AAAI}}, 9635--9643.

\bibitem[{Alford, Kuter, and Nau(2009)}]{Alford09}
Alford, R.; Kuter, U.; and Nau, D. 2009.
\newblock Translating {HTN}s to {PDDL:} {A} Small Amount of Domain Knowledge
  Can Go a Long Way.
\newblock In \emph{{IJCAI}}, 1629--1634.

\bibitem[{Alford et~al.(2016)Alford, Shivashankar, Roberts, Frank, and
  Aha}]{Alford16}
Alford, R.; Shivashankar, V.; Roberts, M.; Frank, J.; and Aha, D. 2016.
\newblock $\!\!$Hierarchical Planning: Relating Task and Goal Decomposition
  with Task Sharing.
\newblock In \emph{{IJCAI}}, 3022--3029.

\bibitem[{Barringer, Kuiper, and Pnueli(1986)}]{barringer1986}
Barringer, H.; Kuiper, R.; and Pnueli, A. 1986.
\newblock A really abstract concurrent model and its temporal logic.
\newblock In \emph{ACM SIGACT-SIGPLAN symposium on Principles of programming
  languages}, 173--183.

\bibitem[{Behnke(2021)}]{behnke2021}
Behnke, G. 2021.
\newblock Block {{Compression}} and {{Invariant Pruning}} for {{SAT-based
  Totally-Ordered HTN Planning}}.
\newblock In \emph{ICAPS}, 25--35.

\bibitem[{Behnke et~al.(2019)Behnke, H{\"o}ller, Bercher, Biundo, Pellier,
  Fiorino, and Alford}]{Holler19b}
Behnke, G.; H{\"o}ller, D.; Bercher, P.; Biundo, S.; Pellier, D.; Fiorino, H.;
  and Alford, R. 2019.
\newblock Hierarchical planning in the {IPC}.
\newblock In \emph{ICAPS Workshop on the International Planning Competition}.

\bibitem[{Behnke, H{\"o}ller, and Biundo(2018)}]{behnke2018totsat}
Behnke, G.; H{\"o}ller, D.; and Biundo, S. 2018.
\newblock {totSAT}-{T}otally-ordered hierarchical planning through {SAT}.
\newblock In \emph{AAAI}, volume~32.

\bibitem[{Behnke, H{\"o}ller, and Biundo(2019)}]{Behnke2019orderchaos}
Behnke, G.; H{\"o}ller, D.; and Biundo, S. 2019.
\newblock Bringing order to chaos--{A} compact representation of partial order
  in {SAT}-based {HTN} planning.
\newblock In \emph{AAAI}, volume~33, 7520--7529.

\bibitem[{Behnke et~al.(2020)Behnke, H{\"{o}}ller, Schmid, Bercher, and
  Biundo}]{behnke20}
Behnke, G.; H{\"{o}}ller, D.; Schmid, A.; Bercher, P.; and Biundo, S. 2020.
\newblock On Succinct Groundings of {HTN} Planning Problems.
\newblock In \emph{{AAAI}}, 9775--9784.

\bibitem[{Behnke et~al.(2022)Behnke, Pollitt, H{\"o}ller, Bercher, and
  Alford}]{behnke2022}
Behnke, G.; Pollitt, F.; H{\"o}ller, D.; Bercher, P.; and Alford, R. 2022.
\newblock {Making Translations to Classical Planning Competitive with Other HTN
  Planners}.
\newblock In \emph{{AAAI}}, {9687--9697}.

\bibitem[{Bercher, Alford, and H{\"{o}}ller(2019)}]{bercher19}
Bercher, P.; Alford, R.; and H{\"{o}}ller, D. 2019.
\newblock A Survey on Hierarchical Planning - One Abstract Idea, Many Concrete
  Realizations.
\newblock In \emph{IJCAI}, 6267--6275.

\bibitem[{Bercher et~al.(2017)Bercher, Behnke, H{\"o}ller, and
  Biundo}]{Bercher17}
Bercher, P.; Behnke, G.; H{\"o}ller, D.; and Biundo, S. 2017.
\newblock An Admissible {HTN} Planning Heuristic.
\newblock In \emph{IJCAI}, 480--488.

\bibitem[{Bit{-}Monnot, Smith, and Do(2016)}]{Bit-Monnot:16}
Bit{-}Monnot, A.; Smith, D.; and Do, M. 2016.
\newblock Delete-Free Reachability Analysis for Temporal and Hierarchical
  Planning.
\newblock In \emph{ECAI}, volume 285, 1698--1699.

\bibitem[{Bresolin et~al.(2014)Bresolin, Della~Monica, Montanari, Sala, and
  Sciavicco}]{BRESOLIN2014269}
Bresolin, D.; Della~Monica, D.; Montanari, A.; Sala, P.; and Sciavicco, G.
  2014.
\newblock Interval temporal logics over strongly discrete linear orders:
  Expressiveness and complexity.
\newblock \emph{Theoretical Computer Science}, 560: 269--291.

\bibitem[{Broxvall and Jonsson(2003)}]{broxvall03}
Broxvall, M.; and Jonsson, P. 2003.
\newblock Point algebras for temporal reasoning: Algorithms and complexity.
\newblock \emph{Artif. Intell.}, 149(2): 179--220.

\bibitem[{Cushing, Kambhampati, and Weld(2007)}]{cushing2007temporal}
Cushing, W.; Kambhampati, S.; and Weld, D.~S. 2007.
\newblock When is temporal planning really temporal?
\newblock In \emph{IJCAI}, 1852--1859.

\bibitem[{Dvor{\'a}k et~al.(2014)Dvor{\'a}k, Bart{\'a}k, {Bit-Monnot}, Ingrand,
  and Ghallab}]{dvorak2014}
Dvor{\'a}k, F.; Bart{\'a}k, R.; {Bit-Monnot}, A.; Ingrand, F.; and Ghallab, M.
  2014.
\newblock Planning and {{Acting}} with {{Temporal}} and {{Hierarchical
  Decomposition Models}}.
\newblock In \emph{ICTAI}, 115--121.

\bibitem[{Erol, Hendler, and Nau(1994)}]{erol94}
Erol, K.; Hendler, J.; and Nau, D. 1994.
\newblock {HTN} Planning: Complexity and Expressivity.
\newblock In \emph{{AAAI}}, 1123--1128.

\bibitem[{Fox and Long(2003)}]{fox03}
Fox, M.; and Long, D. 2003.
\newblock {PDDL2.1:} An Extension to {PDDL} for Expressing Temporal Planning
  Domains.
\newblock \emph{Int. J. of Artif. Intell. Res.}, 20: 61--124.

\bibitem[{Georgievski et~al.(2017)Georgievski, Nizamic, Lazovik, and
  Aiello}]{Georgievski17}
Georgievski, I.; Nizamic, F.; Lazovik, A.; and Aiello, M. 2017.
\newblock Cloud Ready Applications Composed via {HTN} Planning.
\newblock In \emph{{IEEE} Conference on Service-Oriented Computing and
  Applications}, 81--89.

\bibitem[{Gerevini and Long(2005)}]{gerevini05}
Gerevini, A.; and Long, D. 2005.
\newblock Plan constraints and preferences in {PDDL3} - the language of the
  fifth {I}nternational {P}lanning {C}ompetition.
\newblock Technical Report 2005-08-07, Department of Electronics for Automation
  (Imperial College).

\bibitem[{Ghallab, Nau, and Traverso(2016)}]{ghallabnautraverso2016}
Ghallab, M.; Nau, D.; and Traverso, P. 2016.
\newblock \emph{Automated {P}lanning and {A}cting}.
\newblock Cambridge University Press.
\newblock Chap. 4.

\bibitem[{Helmert(2009)}]{helmert}
Helmert, M. 2009.
\newblock Concise finite-domain representations for PDDL planning tasks.
\newblock \emph{Artif. Intell.}, 173(5-6): 503--535.

\bibitem[{H{\"{o}}ller et~al.(2020)H{\"{o}}ller, Behnke, Bercher, Biundo,
  Fiorino, Pellier, and Alford}]{holler20}
H{\"{o}}ller, D.; Behnke, G.; Bercher, P.; Biundo, S.; Fiorino, H.; Pellier,
  D.; and Alford, R. 2020.
\newblock {HDDL:} An Extension to {PDDL} for Expressing Hierarchical Planning
  Problems.
\newblock In \emph{{AAAI}}, 9883--9891.

\bibitem[{H{\"{o}}ller and Bercher(2021)}]{Holler21}
H{\"{o}}ller, D.; and Bercher, P. 2021.
\newblock Landmark Generation in {HTN} Planning.
\newblock In \emph{{AAAI}}, 11826--11834.

\bibitem[{H{\"{o}}ller et~al.(2019)H{\"{o}}ller, Bercher, Behnke, and
  Biundo}]{Holler19}
H{\"{o}}ller, D.; Bercher, P.; Behnke, G.; and Biundo, S. 2019.
\newblock On Guiding Search in {HTN} Planning with Classical Planning
  Heuristics.
\newblock In \emph{IJCAI}, 6171--6175.

\bibitem[{Mcdermott et~al.(1998)Mcdermott, Ghallab, Howe, Knoblock, Ram,
  Veloso, Weld, and Wilkins}]{mcdermott98}
...
\bibitem[{Menif, Jacopin, and Cazenave(2014)}]{Menif14}
Menif, A.; Jacopin, E.; and Cazenave, T. 2014.
\newblock {SHPE: HTN Planning for Video Games}.
\newblock In \emph{{W}orkshop on {C}omputer {G}ames}, 119--132.

\bibitem[{Milot et~al.(2021)Milot, Chauveau, Lacroix, and Lesire}]{Milot21}
Milot, A.; Chauveau, E.; Lacroix, S.; and Lesire, C. 2021.
\newblock {Solving Hierarchical Auctions with HTN Planning}.
\newblock In \emph{{ICAPS Workshop on Hierarchical Planning}}.

\bibitem[{Pellier and Fiorino(2018)}]{Pellier18}
Pellier, D.; and Fiorino, H. 2018.
\newblock {PDDL4J}: a planning domain description library for {J}ava.
\newblock \emph{J. Exp. Theor. Artif. Intell.}, 30(1): 143--176.

\bibitem[{Ramoul et~al.(2017)Ramoul, Pellier, Fiorino, and Pesty}]{ramoul17}
Ramoul, A.; Pellier, D.; Fiorino, H.; and Pesty, S. 2017.
\newblock Grounding of {HTN} Planning Domain.
\newblock \emph{Int. J. of Artif. Intell. Tools}, 26(5).

\bibitem[{Rintanen, Heljanko, and Niemel{\"{a}}(2006)}]{rintanen06}
Rintanen, J.; Heljanko, K.; and Niemel{\"{a}}, I. 2006.
\newblock Planning as satisfiability: parallel plans and algorithms for plan
  search.
\newblock \emph{Artif. Intell.}, 170(12-13): 1031--1080.

\bibitem[{Schreiber(2021)}]{Schreiber21}
Schreiber, D. 2021.
\newblock Lilotane: {A} Lifted {SAT}-based Approach to Hierarchical Planning.
\newblock \emph{J. of Artif. Intell. Res.}, 70: 1117--1181.

\bibitem[{Schreiber et~al.(2019)Schreiber, Pellier, Fiorino, and
  Balyo}]{Schreiber2019SAT}
Schreiber, D.; Pellier, D.; Fiorino, H.; and Balyo, T. 2019.
\newblock Tree-{REX}: {SAT}-Based Tree Exploration for Efficient and
  High-Quality {HTN} Planning.
\newblock In \emph{ICAPS}, 382--390.

\bibitem[{Shivashankar, Alford, and Aha(2017)}]{Shivashankar17}
Shivashankar, V.; Alford, R.; and Aha, D. 2017.
\newblock Incorporating Domain-Independent Planning Heuristics in Hierarchical
  Planning.
\newblock In \emph{{AAAI}}, 3658--3664.

\bibitem[{Smith, Frank, and Cushing(2008)}]{smith08}
Smith, D.; Frank, J.; and Cushing, W. 2008.
\newblock The {ANML} Language.
\newblock In \emph{ICAPS Workshop on Knowledge Engineering for Planning and
  Scheduling}.
