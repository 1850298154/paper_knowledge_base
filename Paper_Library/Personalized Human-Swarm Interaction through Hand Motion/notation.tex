...
\newcommand{\mm}[1]{\colorbox{NavyBlue}{\color{white}   \textsf{\textbf{mm}}} \textcolor{NavyBlue}{ #1}}
\newcommand{\ld}[1]{\colorbox{Melon}{\color{white}   \textsf{\textbf{Ludovic}}} \textcolor{Melon}{ #1}}
...
\newcommand{\rtron}[1]{\colorbox{Plum}{\color{white}\textsf{\textbf{rtron}}}
  {\color{Plum}#1}}
\newcommand{\fschiano}[1]{\colorbox{ForestGreen}{\color{white}   \textsf{\textbf{fs}}} \textcolor{ForestGreen}{#1}}
% \renewcommand{\fschiano}[1]{}
% \newcommand{\mm}[1]{\colorbox{NavyBlue}{\color{white}   \textsf{\textbf{mm}}} \textcolor{NavyBlue}{#1}}
%\newcommand{\fschiano}[1]{}  %comment not showed
\renewcommand{\mm}[1]{}  %comment not showed
